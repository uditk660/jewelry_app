...
ActiveRecord::Schema.define(version: 20260116123000) do
  ...
  create_table "inventory_items", force: :cascade do |t|
    ...
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
    t.index ["jewelry_item_id"], name: "index_inventory_items_on_jewelry_item_id"
  end

  create_table "jewellery_categories", force: :cascade do |t|
    t.integer  "metal_id",                  null: false
    t.string   "name"
    t.boolean  "active",     default: true
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.index ["metal_id"], name: "index_jewellery_categories_on_metal_id"
  end
  ...
  create_table "jewelry_items", force: :cascade do |t|
    ...
    t.index ["jewellery_category_id"], name: "index_jewelry_items_on_jewellery_category_id"
    t.index ["metal_id"], name: "index_jewelry_items_on_metal_id"
    t.index ["purity_id"], name: "index_jewelry_items_on_purity_id"
    t.index ["sku"], name: "index_jewelry_items_on_sku", unique: true
  end
  ...
  create_table "line_items", force: :cascade do |t|
    ...
    t.index ["jewelry_item_id"], name: "index_line_items_on_jewelry_item_id"
    t.index ["order_id"], name: "index_line_items_on_order_id"
  end

  create_table "metal_stock_movements", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["metal_stock_id"], name: "index_metal_stock_movements_on_metal_stock_id"
  end

  create_table "metal_stocks", force: :cascade do |t|
    t.integer  "metal_id",                         null: false
    ...
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.index ["metal_id", "store_id"], name: "index_metal_stocks_on_metal_id_and_store_id", unique: true
    t.index ["metal_id"], name: "index_metal_stocks_on_metal_id"
    t.index ["store_id"], name: "index_metal_stocks_on_store_id"
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["stock_decremented_at"], name: "index_orders_on_stock_decremented_at"
  end

  create_table "purities", force: :cascade do |t|
    t.integer  "metal_id",                                               null: false
    t.string   "name"
    ...
    t.datetime "created_at",                                             null: false
    t.datetime "updated_at",                                             null: false
    t.index ["metal_id"], name: "index_purities_on_metal_id"
  end
  ...
  create_table "rates", force: :cascade do |t|
    ...
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.index ["date", "metal_type"], name: "index_rates_on_date_and_metal_type", unique: true
  end
